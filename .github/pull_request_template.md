...
1. You made changes in a separate "feature" branch (for example, `feat/seo-astro`)
...
<!-- Limit your pull request to one type. -->

- [ ] Update existing tutorial (new feature or functionality)
- [ ] Fix existing tutorial (broken link or wrong formatting)
- [ ] Add a new tutorial
- [ ] Other (please describe):

<!-- Add any other information that is important to understand and review this PR -->
...
| ------------------------------------------------------------------------------------------------ | --- |
| Notion page                                                                                      |     |
| Link to the story in the [CMS](https://app.storyblok.com/#/me/spaces/212319/stories/0/0/index/0) |     |
| Link to the published article on the [website](https://www.storyblok.com/tutorials)                 |     |

<!--Feel free to add any other relevant resource (Slack thread, Figma file, Jira ticket, etc.) to the list above.-->
